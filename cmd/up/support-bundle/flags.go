...
type commonFlags struct {
	...
	IncludeNamespaces []string `help:"Namespaces to include in the support bundle. Supports glob patterns (e.g., upbound-* to include all namespaces starting with \"upbound-\"). Multiple patterns can be specified."   name:"include-namespaces"`
