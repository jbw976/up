	...
	tcs := map[string]struct {
		...
		"SpaceVersion131FolderOutput": {
			...
			expectedOutput: []string{
				...
				"crane pull xpkg.upbound.io/spaces-artifacts/mxp-benchmark:v1.13.1 testdata/output/mxp-benchmark-v1.13.1.tgz",
		...
		"SpaceVersion180RegistryOutput": {
			...
			expectedOutput: []string{
				"crane copy xpkg.upbound.io/spaces-artifacts/agent:0.0.0-649.g97cc957 haarchri.io/spaces/agent:0.0.0-649.g97cc957",
				"crane copy xpkg.upbound.io/spaces-artifacts/agent:v0.0.0-649.g97cc957 haarchri.io/spaces/agent:v0.0.0-649.g97cc957",
				...
				"crane copy xpkg.upbound.io/spaces-artifacts/register-init:v0.0.0-649.g97cc957 haarchri.io/spaces/register-init:v0.0.0-649.g97cc957",
