...
func TestCreateUnstructuredObject(t *testing.T) { //nolint:tparallel // Cannot use t.Parallel() due to concurrent map write issues in fake client scheme registry
