...
//go:generate go run -tags generate github.com/google/addlicense -v -ignore **/testdata/** -ignore **/vendor/** -ignore ../cmd/up/function/templates/** -ignore ../cmd/up/test/templates/** -c "Upbound Inc" . ../cmd ../pkg
